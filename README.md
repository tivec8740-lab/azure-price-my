...
## What it shows
- ~1,900 VM SKUs + PostgreSQL/MySQL Flexible Server tiers, Linux Standard tier only
...
- One file per currency: `data/pricing_<cc>.json` (MYR, USD, SGD, AUD, EUR, GBP, INR, JPY)
